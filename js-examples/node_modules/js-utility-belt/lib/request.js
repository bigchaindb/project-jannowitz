...
var _format_text = require('./text/format_text');

var _format_text2 = _interopRequireDefault(_format_text);

var _stringify_as_query_param = require('./url/stringify_as_query_param');
...
function request(url) {
    ...
    var urlTemplateSpec = _ref.urlTemplateSpec;

    var fetchConfig = _objectWithoutProperties(_ref, ['jsonBody', 'query', 'urlTemplateSpec']);
    ...
    return fetch(expandedUrl, fetchConfig).then(function (res) {
